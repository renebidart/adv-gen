...
from utils.data import make_generators_DF_art
...
parser.add_argument('--latent_size', default=16, type=int, help='model')
parser.add_argument('--latent_size_layer1', default=16, type=int, help='model')
...
def main(args):
    ...
    # Make generators:
    dataloaders = make_generators_DF_art(files_dict=files_dict, base_path=base_path, batch_size=batch_size, IM_SIZE=IM_SIZE, 
